...
const AddFriendButton:FC<AddFriendButtonProps> = ({})=>{
   ...
   <div className="mt-2 flex gap-4">
    <input 
    {...register('email')}
    type="text" className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset-300 ring-gray-300 placeholder:text-gray-400 focus-ring-2 
